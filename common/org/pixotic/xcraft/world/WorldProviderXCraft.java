...
public class WorldProviderXCraft extends WorldProvider {
    private float[] colorsSunriseSunset = new float[4];
    
    public void registerWorldChunkManager() {
        this.dimensionId = XCraft.XCraftDimID;
        this.worldChunkMgr = new WorldChunkManagerHell(XCraft.XCraftBiomeGen, this.dimensionId, this.dimensionId);
        this.hasNoSky = false;
    }
    
    public IChunkProvider createChunkGenerator() {
        return new ChunkProviderXCraft(this.worldObj, this.worldObj.getSeed(), false);
    }
    ...
    public String getSunTexture() {
        ...
        return Reference.MOD_ID + ":elerium";
    }
    ...
    public String getWelcomeMessage() {
        if ((this instanceof WorldProviderXCraft)) {
            return "HIDDEN MOVEMENT. Just kidding, entering the X-Craft test dimension!";
        }
        return null;
    }
