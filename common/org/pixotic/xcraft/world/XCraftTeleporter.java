...
public class XCraftTeleporter extends Teleporter {
    ...
    */
    ...
    public XCraftTeleporter(WorldServer par1WorldServer) {
    ...
    */
    public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
        if (this.worldServerInstance.provider.dimensionId != 1) {
            ...
            int posX = MathHelper.floor_double(par1Entity.posX);
            int posY = MathHelper.floor_double(par1Entity.posY);
            int posZ = MathHelper.floor_double(par1Entity.posZ); 
            
            for (int x = posX - 3; x < posX + 4; x++) {
                for (int z = posZ - 4; z < posZ + 4; z++) {
                     /** change these blocks **/
                     this.worldServerInstance.setBlock(x, posY-3, z, ModBlocks.alienAlloy.blockID);
                 }
            }
            par1Entity.setLocationAndAngles((double)posX, (double)posY, (double)posZ, par1Entity.rotationYaw, 0.0F);
...
//         if (d3 >= 0.0D) {
//             if (flag) {
//                 this.destinationCoordinateCache.add(j1, new XCraftPortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
...
//             int j2 = -1;
//             /** change this block **/
//             if (this.worldServerInstance.getBlockId(i - 1, j, k) == Block.blockRedstone.blockID) {
//                 j2 = 2;
//             }
//             /** change this block **/
//             if (this.worldServerInstance.getBlockId(i + 1, j, k) == Block.blockRedstone.blockID) {
